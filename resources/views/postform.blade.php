<x-app-layout>
    ...
    <form method="post" action="{{ route('posts.store') }}" enctype="multipart/form-data">
        ...
        <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
            ...
            <input name="title" class="title bg-gray-100 border border-gray-300 p-2 mb-4 outline-none" spellcheck="false" placeholder="Заголовок" maxlength="255" type="text">

            @error('text')
            <p class="text-sm text-red-600">{{ $message }}</p>
            @enderror

            <textarea name="text" class="description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none" spellcheck="false" maxlength="10000" placeholder="Текст поста"></textarea>
